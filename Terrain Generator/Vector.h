/*
Vector class: represents a vector in 

The class implements most of the mathematical operations between vectors in 3D space (x,y,z,w coordinates).

The class was originally part of a framework for PS2 development by Henry S. Fortuna (http://www.hsfortuna.pwp.blueyonder.co.uk/);
I adapted it to work for almost any program by removing PS2 specific code.
Only requirement now is the C math library
*/
